...
#define	TMP_FILE_TAIL				".tmp"						/* 临时文件扩展名 */
#define	LOG_FILE_TAIL				".log"						/* 日志文件扩展名 */

#define	FILE_NOTE_FLAG				"#"							/* 文件记录注释标志 */
#define	CHAR_NEW_LINE				"\n"						/* 换行符  */
#define FILE_FIELD_SEP				"\t "						/* 记录各域间的分隔符 */
#define	GROUP_KEY_SEP				"/"							/*  */

#define	MOBILE_HEAD_FLAG			"13"						/* 手机号码头标志 */
#define	VIRTUL_HEAD_FLAG			"20"						/* 虚拟号码头标志 */
#define	MOBILE_HEAD_LEN				7							/* 手机号码头长度 */
#define	MOBILE_NUMBER_LEN			11							/* 手机号码头长度 */

#define	MAX_MONTH_DAY				31							/* 一个月最大的天数 */
